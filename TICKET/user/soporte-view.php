<div class="container">
  <div class="row well">
    ...
    <div class="col-sm-9 lead">
      <h2 class="text-info">Bienvenido al centro de soporte de Del Rio Motors</h2>
      <p>Es muy facil de usar, si usted tiene problemas con alguno equipo de computo nos puede enviar un nuevo ticket, nosotros lo respondemos y solucionaremos su problema.<br>Si ya nos ha enviado un ticket puede consultar el estado de este mediante su <strong>Ticket ID</strong>.</p>
    </div>
  </div><!--fin row 1-->
    ...
    <div class="col-sm-6">
      <div class="panel panel-info">
        ...
        <div class="panel-body text-center">
          ...
          <p class="text-justify">Si tienes un problema con cualquier equipo de TI reportalo creando un nuevo ticket y te ayudaremos a solucionarlo.Si desea actualizar una peticion ya realizada utiliza el formulario de la derecha <em>Comprobar estado de Ticket</em>, solamente los <strong>usuarios registrados</strong> pueden abrir un nuevo ticket.</p>
